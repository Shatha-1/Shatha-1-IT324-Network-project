...
public class reservationFrame extends javax.swing.JFrame {
    ...
    public reservationFrame(Socket socket, PrintWriter out, BufferedReader in) {
        initComponents();
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        jComboBox4.setVisible(false);   // hide slots combo box
        jButton3.setVisible(false);     // hide Reserve button
        jLabel6.setVisible(false);      // hide Select Slot label
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Choose Parking Spot");
        ...
        jLabel2.setText("Select Location (1-3):");
        ...
        jLabel4.setText("Select Duration (1-7):");

        jButton2.setText("Show Available Slots");
